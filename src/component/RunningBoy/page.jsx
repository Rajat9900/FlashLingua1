...
import RunningBoyimg from "../../assets/RunningBoy.png"
            ...
            <div className="container">
                <div className="row">
                    <div className="col-6 m-auto text-center">
                        <p>English to Portuguese</p>
                        <p style={{ color: "#4CAF50", fontWeight: "600" }}>in English</p>
                        <p className="mb-5">Running stay to healthy</p>

                        <img src={RunningBoyimg} className='m-auto' alt="" />
                        <input type="file" accept="audio/*" onChange={handleFileChange} className="form-control m-auto mt-4" style={{ width: '400px' }} />
                       
                        {file ? (
             <div className="d-flex mt-5" style={{ margin: "auto", width: "fit-content", height: "fit-content", display: "flex", alignItems: "center", border:"1px solid #E6E6E6",padding:"17px 30px",borderRadius:"15px" }}>
